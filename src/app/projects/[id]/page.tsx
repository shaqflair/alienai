...
export default async function ProjectPage({
  ...
  const [
    ...
    // Gate 5 — fully wrapped, never throws redirect
    loadGate5Status(projectUuid),
    // Resource justification — fully wrapped, never throws redirect
    loadResourceJustificationData(projectUuid),
  ]);
  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
      ...
      {/* Gate 5 closure readiness badge — rendered only when data loaded successfully */}
          ...
          {justificationData && (
            <div style={{ marginTop: 16 }}>
              <ResourceJustificationPanel
                ...
                budgetSummary={justificationData.budgetSummary}
