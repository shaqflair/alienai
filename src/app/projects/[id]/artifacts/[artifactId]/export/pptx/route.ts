...
// âœ… REQUIRED: pptxgenjs + Buffer needs Node runtime
...
function addClientHeader(slide: any, brand: Brand) {
  // âœ… Use string shape type to avoid module-format issues
  slide.addShape("rect", {
    x: 0,
    y: 0,
    w: 13.33,
...
function addFooter(slide: any, brand: Brand) {
  ...
  slide.addText(`Confidential â€“ ${brand.clientName} â€“ Generated by AlienAI â€“ ${today}`, {
    x: 0.55,
    y: 7.25,
    w: 12.2,
    h: 0.25,
...
export async function GET(req: NextRequest,
  ...
  try {
    // âœ… FIX: Next 15/16 dynamic route params
    ...
    // Cover
    {
      ...
      slide.addText(
        `Status: ${status.toUpperCase()}   Version: ${String((artifact as any).version ?? "â€”")}`,
    ...
    for (const s of sections) {
      ...
      slide.addText(stringifyFallback(s.content_json) || "â€”", {
        x: 0.8,
        y: 1.7,
        w: 11.8,
        h: 5.3,
    ...
    // âœ… This makes your 500 actionable
