                ...
                <div style={{ flex: 1, height: 2, background: T.hr, borderRadius: 2, overflow: "hidden" }}>
                  <div
                    style={{
                      height: "100%",
                      width: `${v}%`,
                      background: RAG[pr].fg,
                      borderRadius: 2,
                      opacity: 0.7,
                    }}
                  />
                </div>
                <Mono size={11} color={RAG[pr].fg} weight={600}>
                  {v}
                </Mono>
              </div>
            );
  ...
  return (
    <>
      <tr
        ...
        style={{
          cursor: "pointer",
          background: expanded ? "#faf9f7" : T.surface,
        ...
        <td style={{ padding: "12px 16px", verticalAlign: "middle" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              {over && (
                <Mono size={9} color={RAG.R.fg} weight={600} upper>
                  Overdue
                </Mono>
              )}
            </div>
        ...
        <td style={{ padding: "12px 16px", verticalAlign: "middle", width: 90 }}>
          {item.score != null ? (
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <Mono size={12} color={rc.fg} weight={600}>
                {item.score}
              </Mono>
            </div>
          ) : (
        ...
        <td style={{ padding: "12px 16px", verticalAlign: "middle", width: 90 }}>
          {item.sla_breach_probability != null ? (
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <Pip
                rag={num(item.sla_breach_probability) >= 70 ? "R" : num(item.sla_breach_probability) >= 40 ? "A" : "G"}
                pulse={num(item.sla_breach_probability) >= 70}
              />
              <Mono size={11} color={T.ink3} weight={500}>
                    ...
                    {[
                      ...
                      .map(([k, v]) => (
                        ...
                        >
                          ...
                          <Mono size={11} color={T.ink2} weight={500}>
                            {v}
                          </Mono>
                        </div>
                      ))}
    ...
    <div
      style={{
        ...
        borderLeft: `3px solid ${
          insight.severity === "high" ? RAG.R.fg : insight.severity === "medium" ? RAG.A.fg : "#1d4ed8"
        }`,
        padding: "16px 20px",
        cursor: "pointer",
        transition: "background 0.1s",
          ...
          {expanded && (
            <p
              style={{
                ...
                margin: "10px 0 0",
                fontWeight: 300,
                animation: "drawerOpen 0.15s ease-out",
              }}
            >
              {insight.body}
            </p>
      ...
      >
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "40px 40px 100px" }}>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 32 }}>
              <div>
                ...
                >
                  {execData?.summary?.headline ||
                    "RAID signals, SLA threats and financial exposure across all active projects — distilled for executive action."}
                </p>
              </div>
              ...
              <div style={{ flexShrink: 0, textAlign: "right" }}>
                {execData?.meta && (
                  <>
                    <Mono size={10} color={T.ink4} upper>
                      {execData.meta.projectCounts?.filtered ?? execData.meta.projectCounts?.active ?? "—"} projects in
                      scope
                    </Mono>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 3 }}>
              {WINDOWS.map((w) => (
                <Pill key={w} label={`${w}D`} active={windowDays === w} onClick={() => setWindowDays(w)} />
              ))}
            </div>
            ...
            >
              ...
              {healthScore != null ? (
                <KpiCell
                  ...
                  value={`${healthScore}%`}
                  sub={healthScore >= 85 ? "green" : healthScore >= 70 ? "amber" : "red"}
              ...
              <div style={{ padding: "20px 24px" }}>
                ...
                <div
                  style={{
                    ...
                    marginTop: 8,
                    marginBottom: 4,
                    color: kpis.exposure_total > 0 ? RAG.A.fg : T.ink4,
                  }}
                >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ background: T.surface, border: `1px solid ${T.hr}`, padding: "28px 32px" }}>
                  ...
                  {execData?.summary?.generated_at && (
                    <div style={{ marginTop: 16 }}>
                      <Mono size={10} color={T.ink5}>
                        Generated {fmtUkDate(execData.summary.generated_at)}
                      </Mono>
                    </div>
                  )}
                </div>
                ...
                {sections
                  ...
                  .map((sec) => (
                    <div key={sec.key} style={{ background: T.surface, border: `1px solid ${T.hr}`, overflow: "hidden" }}>
                      ...
                      >
                        <div style={{ fontFamily: T.serif, fontSize: 17, fontWeight: 600, color: T.ink }}>
                          {sec.title}
                        </div>
                        <button
                  ...
                  <div style={{ background: T.surface, border: `1px solid ${T.hr}`, padding: "28px 28px" }}>
                    ...
                    {health?.projectCount && (
                      <div style={{ marginTop: 16, borderTop: `1px solid ${T.hr}`, paddingTop: 14 }}>
                        <Mono size={10} color={T.ink5} upper>
                          {health.projectCount} active projects · {windowDays}d window
                        </Mono>
                      </div>
                    )}
                  </div>
          ...
          {!execLoading && activeTab === "raid" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 20, animation: "fadeUp 0.4s 0.1s ease both" }}>
              {sections.length === 0 || sections.every((s) => s.items.length === 0) ? (
                ...
                >
                  <Mono size={12} color={T.ink5}>
                    No items match the current window and scope.
                  </Mono>
                </div>
              ) : (
                <>
          ...
          {activeTab === "ai" && (
            <div style={{ animation: "fadeUp 0.4s 0.1s ease both" }}>
              {insLoading ? (
                ...
                >
                  <Mono size={12} color={T.ink5}>
                    No active AI signals for this window.
                  </Mono>
                </div>
              ) : (
                <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
              ...
              return (
                <div style={{ display: "flex", flexDirection: "column", gap: 20, animation: "fadeUp 0.4s 0.1s ease both" }}>
                      ...
                      <div key={label} style={{ padding: "20px 24px", borderRight: `1px solid ${T.hr}` }}>
                        ...
                        <div
                          style={{
                            ...
                            marginTop: 8,
                            marginBottom: 4,
                            color: alert ? RAG.R.fg : value === "—" ? T.ink4 : T.ink,
                          }}
                        >
                          {value}
                        </div>
                  ...
                  {projectList.length > 0 && (
                    <div style={{ background: T.surface, border: `1px solid ${T.hr}`, padding: "24px 28px" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
                        ...
                        <div style={{ flex: 1, height: 1, background: T.hr }} />
                        <Mono size={10} color={T.ink5}>
                          {projectList.length} projects with exposure
                        </Mono>
                      </div>
                          ...
                          return (
                            <div key={proj} style={{ display: "flex", alignItems: "center", gap: 14 }}>
                              <div style={{ width: 180, flexShrink: 0 }}>
                                <Mono size={10} color={T.ink3} weight={500}>
                                  {proj}
                                </Mono>
                              </div>
                              <div style={{ flex: 1, height: 6, background: T.hr, borderRadius: 3, overflow: "hidden" }}>
                                <div
                                  style={{
                                    ...
                                    background: rag === "N" ? T.ink3 : RAG[rag].fg,
                                    borderRadius: 3,
                              ...
                              <div style={{ width: 80, textAlign: "right", flexShrink: 0 }}>
                                <Mono size={12} color={rag === "N" ? T.ink3 : RAG[rag].fg} weight={600}>
                                  {fmt(val)}
                                </Mono>
                              </div>
                  ...
                  {finLoading && (
                    ...
                    >
                      <Mono size={11} color={T.ink5}>
                        RETRIEVING FINANCIAL EXPOSURE DATA…
                      </Mono>
                    </div>
                  )}
                  ...
                  {!finLoading && finItems.length === 0 && (
                    ...
                    >
                      <Mono size={12} color={T.ink5}>
                        No financial exposure recorded against RAID items.
                      </Mono>
                      <div style={{ marginTop: 12 }}>
                        <Mono size={10} color={T.ink5}>
                          Add cost, revenue risk or penalty estimates to RAID items to see them here.
                        </Mono>
                      </div>
                    </div>
                  )}
                  ...
                  {!finLoading && sorted.length > 0 && (
                    <div style={{ background: T.surface, border: `1px solid ${T.hr}`, overflow: "hidden" }}>
                      ...
                      >
                        ...
                        <Mono size={10} color={T.ink5} upper>
                          {sorted.length} items · click column to sort
                        </Mono>
                      </div>
                              ...
                              return (
                                <tr key={it.id} style={{ background: T.surface }} className="ms-row">
                                  ...
                                  <td style={{ ...TD, minWidth: 260 }}>
                                    ...
                                    <Mono size={10} color={T.ink4}>
                                      {it.project_title}
                                      {it.project_code ? ` (${it.project_code})` : ""}
                                    </Mono>
                                  </td>
                                  <td style={TD}>
                                    <Mono size={10} color={T.ink3} upper weight={500}>
                                      {it.type}
                                    </Mono>
                                  </td>
                                  <td style={TD}>
                                    <Mono size={11} color={T.ink4}>
                                      {it.due_date_uk || "—"}
                                    </Mono>
                                  </td>
                                  <td style={TD}>
                                  ...
                                  <td style={TD}>
                                    <Mono
                                      size={12}
                                      color={it.est_revenue_at_risk ? RAG.A.fg : T.ink5}
                                      weight={it.est_revenue_at_risk ? 600 : 400}
                                    >
                                      ...
                                      >
                                        <div
                                          style={{
                                            ...
                                            width: `${
                                              totals.total > 0
                                                ? Math.min(100, Math.round((it.total_exposure / totals.total) * 100))
                                                : 0
                                            }%`,
                                            background: rag === "N" ? T.ink4 : rc.fg,
                                            borderRadius: 2,
                                          }}
                                        />
                                      </div>
                                      <Mono size={12} color={rag === "N" ? T.ink2 : rc.fg} weight={600}>
                                        {fmt(it.total_exposure)}
                                      </Mono>
                                    </div>
                                  </td>
                                </tr>
                          ...
                          <tfoot>
                            <tr style={{ background: "#f5f3f0" }}>
                              <td colSpan={4} style={{ padding: "12px 16px", borderTop: `2px solid ${T.hr}` }}>
                                <Mono size={10} color={T.ink4} upper weight={600}>
                                  Portfolio Total
                                </Mono>
                              </td>
                              <td style={{ padding: "12px 16px", borderTop: `2px solid ${T.hr}` }}>
                                <Mono size={12} color={T.ink} weight={600}>
                                  {fmt(totals.cost)}
                                </Mono>
                              </td>
                              <td style={{ padding: "12px 16px", borderTop: `2px solid ${T.hr}` }}>
                                <Mono size={12} color={RAG.A.fg} weight={600}>
                                  {fmt(totals.revenue)}
                                </Mono>
                              </td>
                              <td style={{ padding: "12px 16px", borderTop: `2px solid ${T.hr}` }}>
                                <Mono size={12} color={totals.penalties > 0 ? RAG.R.fg : T.ink5} weight={600}>
                                  {fmt(totals.penalties)}
                                </Mono>
                              </td>
                              <td style={{ padding: "12px 16px", borderTop: `2px solid ${T.hr}` }}>
                                <Mono size={13} color={T.ink} weight={700}>
                                  {fmt(totals.total)}
                                </Mono>
                              </td>
                            </tr>
