...
function Logo({ size = "md" }: { size?: "sm" | "md" | "lg" | "xl" }) {
  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: s.gap }}>
      ...
      >
        <span style={{ color: T.cyan, fontWeight: 700 }}>A</span>
        <span>L</span>
    ...
    <div style={{ position: "relative", width: "100%", height: "100%" }}>
      <canvas
        ...
        onMouseMove={(e) => {
          ...
          const hovered = nodes.find((n) => Math.sqrt((x - n.x) ** 2 + (y - n.y) ** 2) < 8);
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 13, color: T.textMuted }}>Replace this panel with your Loom, YouTube, or Vimeo embed.</div>
          </div>
          <button
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: 560, padding: 24 }}>
              ...
              <p style={{ color: T.textMuted, lineHeight: 1.7, fontSize: 15, marginBottom: 20 }}>
                For now this gives you a working Watch demo experience. When your video is ready,
                replace this section with an iframe or embedded player.
              </p>
              <a
        ...
        >
          ...
          >
            ...
            <a
              ...
              onClick={() => trackEvent("demo_click", { placement: "mobile_nav" })}
              style={{
                width: "100%",
                padding: "14px 16px",
                marginTop: 10,
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px", width: "100%", position: "relative", zIndex: 1 }}>
        ...
        >
          <div>
            ...
            >
              Aliena unifies approvals, RAID, finance, and delivery into one AI-powered governance platform.
              Built for PMOs who refuse to fly blind.
            </p>
            ...
            >
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  >
                    <Brain size={20} color={T.cyan} />
                  </div>
                  <div>
                    <div style={{ fontWeight: 700, fontSize: 15 }}>Aliena intelligence layer</div>
                    <div style={{ fontSize: 12, color: T.textSubtle }}>Live portfolio signal synthesis</div>
                  </div>
                </div>
                <div
                  style={{
              ...
              >
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
                    ...
                    <span style={{ fontFamily: F.mono, fontSize: 11, letterSpacing: "0.08em", color: T.textSubtle }}>
                      GOVERNANCE MAP
                    </span>
                  </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                      ...
                      <span style={{ fontFamily: F.mono, fontSize: 11, color: T.textSubtle, letterSpacing: "0.08em" }}>
                        AT RISK THIS WEEK
                      </span>
                    </div>
                    {[
                      "Board approval pending on financial plan",
                      "Resource pressure building in Programme Alpha",
                      "Milestone slippage probability rising",
                    ].map((item, i) => (
                      <div
                        key={item}
                        style={{
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                      ...
                      <span style={{ fontWeight: 700, color: T.text }}>AI briefing</span>
                    </div>
                    <p style={{ fontSize: 13, color: T.textMuted, lineHeight: 1.7, marginBottom: 14 }}>
                      Two approval delays plus resource strain suggest portfolio confidence may soften next week unless action is taken now.
                    </p>
                    <button
                      type="button"
                      onClick={() => {
                        trackEvent("cta_click", { placement: "hero_panel_watch_demo" });
                        onOpenDemo();
                      }}
                      style={{
                        width: "100%",
            ...
            <div className="preview-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 24, height: 500 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 16, padding: 20, flex: 1 }}>
                  <div style={{ fontFamily: F.mono, fontSize: 10, color: T.textSubtle, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 16 }}>
                    Critical Alerts
                  </div>
                  {[
                    ...
                    <div key={i} style={{ padding: 12, background: T.surface, borderRadius: 8, marginBottom: 8, borderLeft: `2px solid ${alert.type === "risk" ? T.rose : alert.type === "approval" ? T.amber : T.cyan}` }}>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px" }}>
        ...
        <div className="feature-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {features.map((feature) => (
            <div
              key={feature.title}
              style={{ background: T.bgElevated, border: `1px solid ${T.border}`, borderRadius: 20, padding: 32, transition: "all 0.3s", cursor: "pointer" }}
              onMouseEnter={(e) => {
            ...
            >
              <div style={{ width: 48, height: 48, borderRadius: 12, background: `${feature.color}15`, border: `1px solid ${feature.color}30`, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20 }}>
                <feature.icon size={24} color={feature.color} />
              </div>
              <h3 style={{ fontFamily: F.display, fontSize: 20, fontWeight: 600, marginBottom: 12, color: T.text }}>
                {feature.title}
              </h3>
              <p style={{ color: T.textMuted, fontSize: 15, lineHeight: 1.7 }}>{feature.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px" }}>
        ...
        <div className="comparison-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 24, padding: 32 }}>
            <div style={{ fontFamily: F.mono, fontSize: 11, color: T.textSubtle, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 24 }}>
          ...
          <div style={{ background: `linear-gradient(135deg, ${T.cyan}08, transparent)`, border: `1px solid ${T.cyan}40`, borderRadius: 24, padding: 32, position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: 0, right: 0, padding: "8px 16px", background: T.cyan, color: T.bg, fontSize: 11, fontWeight: 700, borderBottomLeftRadius: 12 }}>
              ALIENA AI
            </div>
            <div style={{ fontFamily: F.mono, fontSize: 11, color: T.cyan, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 24 }}>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px" }}>
        <div style={{ textAlign: "center", marginBottom: 70 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 12px", background: `${T.cyan}10`, border: `1px solid ${T.cyan}30`, borderRadius: 999, marginBottom: 14 }}>
            ...
            <span style={{ fontFamily: F.mono, fontSize: 11, color: T.cyan, letterSpacing: "0.08em", textTransform: "uppercase" }}>
              Security
            </span>
          </div>
          <h2 style={{ fontFamily: F.display, fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 700, letterSpacing: "-0.03em", marginBottom: 16 }}>
        ...
        <div className="security-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {[
            ...
            <div key={item.title} style={{ background: T.bgElevated, border: `1px solid ${T.border}`, borderRadius: 20, padding: 28 }}>
              <div style={{ width: 50, height: 50, borderRadius: 14, background: `${T.cyan}15`, border: `1px solid ${T.cyan}30`, display: "grid", placeItems: "center", marginBottom: 18 }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 12px", background: `${T.amber}12`, border: `1px solid ${T.amber}30`, borderRadius: 999, marginBottom: 14 }}>
            ...
            <span style={{ fontFamily: F.mono, fontSize: 11, color: T.amber, letterSpacing: "0.08em", textTransform: "uppercase" }}>
          ...
          <p style={{ color: T.textMuted, fontSize: 18, maxWidth: 720, margin: "0 auto" }}>
            Yes, pricing should be on the page. Even if you do not publish final enterprise rates yet, a pilot option gives cold visitors something concrete to act on.
          </p>
        </div>
        ...
        <div className="pricing-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.15fr", gap: 24, alignItems: "stretch" }}>
          <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 24, padding: 30 }}>
            <div style={{ fontFamily: F.mono, fontSize: 11, color: T.textSubtle, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 14 }}>
            ...
            <p style={{ color: T.textMuted, lineHeight: 1.7, marginBottom: 22 }}>
              Ideal for PMOs who want to validate Aliena on one programme or a controlled portfolio before a broader rollout.
            </p>
          ...
          <div style={{ background: `linear-gradient(135deg, ${T.cyan}10, rgba(255,255,255,0.03))`, border: `1px solid ${T.cyan}30`, borderRadius: 24, padding: 30, position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: 16, right: 16, padding: "8px 12px", borderRadius: 999, background: `${T.cyan}18`, border: `1px solid ${T.cyan}35`, color: T.cyan, fontSize: 11, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase" }}>
              Recommended
            </div>
            <div style={{ fontFamily: F.mono, fontSize: 11, color: T.cyan, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 14 }}>
              Enterprise PMO fit
            </div>
            <h3 style={{ fontSize: 30, fontWeight: 800, marginBottom: 10 }}>Book a pricing conversation</h3>
            <p style={{ color: T.textMuted, lineHeight: 1.7, marginBottom: 24 }}>
              Use this section to qualify demand now, before you publish fixed enterprise packaging. It keeps the page credible without forcing you into premature pricing promises.
            </p>
...
function ResourceSection() {
  const resources = [
    {
      title: "Documentation",
      desc: "Product setup, workflows, and delivery governance guidance.",
      href: "#platform",
    },
    {
      title: "API Reference",
      desc: "Integration direction for future systems and reporting pipelines.",
      href: "mailto:support@aliena.co.uk?subject=Aliena%20API%20reference%20request",
    },
    {
      title: "Guides",
      desc: "How PMOs can operationalise approvals, RAID, and AI governance.",
      href: "mailto:support@aliena.co.uk?subject=Aliena%20guides%20request",
    },
  ];
  ...
  return (
    <section id="resources" style={{ padding: "120px 0" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          <h2 style={{ fontFamily: F.display, fontSize: "clamp(30px, 4vw, 44px)", fontWeight: 700, letterSpacing: "-0.03em", marginBottom: 14 }}>
            Resources that help buyers move faster
          </h2>
          <p style={{ color: T.textMuted, fontSize: 18, maxWidth: 740, margin: "0 auto" }}>
            Rather than leaving dead links in the footer, give visitors useful next steps now and expand these into full pages later.
          </p>
        </div>
        ...
        <div className="resources-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {resources.map((item) => {
            ...
            return (
              <div key={item.title} style={{ background: T.bgElevated, border: `1px solid ${T.border}`, borderRadius: 20, padding: 28 }}>
                <div style={{ width: 48, height: 48, borderRadius: 12, background: `${T.cyan}12`, border: `1px solid ${T.cyan}25`, display: "grid", placeItems: "center", marginBottom: 18 }}>
                  <Sparkles size={20} color={T.cyan} />
                </div>
                <h3 style={{ fontSize: 20, fontWeight: 700, marginBottom: 10 }}>{item.title}</h3>
                <p style={{ fontSize: 15, lineHeight: 1.7, color: T.textMuted, marginBottom: 18 }}>{item.desc}</p>
                {isAnchor ? (
                  <AnchorLink
                    href={item.href}
                    style={{
                  ...
                  <a
                    href={withUtm(item.href, "resources")}
                    style={{
                      display: "inline-flex",
                      alignItems: "center",
                      gap: 8,
                    ...
                    onClick={() => trackEvent("cta_click", { placement: "resources", resource: item.title })}
                  >
  ...
  const cards = [
    {
      ...
      icon: Shield,
      title: "Privacy",
      body: "Aliena is designed for responsible handling of governance and operational data. Full privacy policy can be published here when ready.",
    },
    {
      id: "terms",
      icon: FileCheck,
      title: "Terms",
      body: "Use this section for commercial terms, acceptable use, and early access participation terms.",
    },
    {
      id: "cookies",
      icon: Activity,
      title: "Cookies",
      body: "If you add analytics, document the categories used and give visitors transparency around measurement.",
    },
  ];

  return (
    <section id="legal" style={{ padding: "120px 0", background: T.bgElevated }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          <h2 style={{ fontFamily: F.display, fontSize: "clamp(30px, 4vw, 44px)", fontWeight: 700, letterSpacing: "-0.03em", marginBottom: 14 }}>
            Legal foundations for enterprise trust
          </h2>
          <p style={{ color: T.textMuted, fontSize: 18, maxWidth: 760, margin: "0 auto" }}>
            These sections stop your footer from feeling unfinished and give you a clear place to expand formal policy content next.
          </p>
        </div>

        <div className="legal-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {cards.map((card) => (
            <div key={card.id} id={card.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 20, padding: 28 }}>
              <div style={{ width: 50, height: 50, borderRadius: 14, background: `${T.cyan}14`, border: `1px solid ${T.cyan}30`, display: "grid", placeItems: "center", marginBottom: 18 }}>
                <card.icon size={22} color={T.cyan} />
              </div>
              <h3 style={{ fontSize: 22, fontWeight: 700, marginBottom: 10 }}>{card.title}</h3>
              <p style={{ fontSize: 15, lineHeight: 1.75, color: T.textMuted }}>{card.body}</p>
            </div>
          ))}
        </div>
      </div>
...
function Footer({
  ...
  const productLinks = [
    ...
    { label: "Security", href: "#security" },
    { label: "Pricing", href: "#pricing" },
    { label: "Watch demo", action: "demo" as const },
  ];
  ...
  const resourceLinks = [
    ...
    { label: "Guides", href: "mailto:support@aliena.co.uk?subject=Aliena%20guides%20request" },
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px" }}>
        <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 60, marginBottom: 60 }}>
          <div>
            ...
            <a
              href={withUtm("mailto:support@aliena.co.uk?subject=Book%20an%20Aliena%20demo", "footer_brand")}
              style={{
                marginTop: 18,
                display: "inline-flex",
                alignItems: "center",
            ...
            {resourceLinks.map((item) =>
              item.href.startsWith("#") ? (
                ...
                <a
                  ...
                  style={{ display: "block", color: T.textMuted, fontSize: 14, padding: "8px 0", textDecoration: "none" }}
                  onClick={() => trackEvent("cta_click", { placement: "footer_resources", label: item.label })}
                >
                  {item.label}
                </a>
              )
...
function CommandBar({
  ...
  return (
    <div style={{ position: "fixed", bottom: 32, left: "50%", transform: "translateX(-50%)", zIndex: 100 }}>
      ...
      >
        <div style={{ width: 32, height: 32, borderRadius: 8, background: T.cyanSubtle, border: `1px solid ${T.cyan}30`, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <Sparkles size={16} color={T.cyan} />
        </div>
        ...
        <div style={{ padding: "4px 8px", background: T.surface, borderRadius: 6, fontFamily: F.mono, fontSize: 11, color: T.textSubtle, border: `1px solid ${T.border}` }}>
          ?K
        </div>
      </button>
    </div>
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      requestAnimationFrame(() => {
        ...
        const newDepth = thresholds.reduce((acc, t) => (pct >= t ? t : acc), 0);

        if (newDepth > scrollDepth) {
          setScrollDepth(newDepth);
          trackEvent("scroll_depth", { percent: newDepth });
        }
