...
export default function AuthForm({ next }: { next?: string }) {
  ...
  const showResend = useMemo(() => {
    ...
    return (
      mode === "signin" &&
      !!pendingEmail &&
      (e.includes("confirm") || e.includes("verified") || e.includes("verification") || e.includes("not confirmed"))
    );
    ...
    <>
      <style>{`
        ...
        .auth-hud {
          ...
          color: rgba(135, 230, 255, 0.82);
          line-height: 1.75;
          text-shadow:
            0 0 8px rgba(0, 184, 219, 0.45),
            0 0 18px rgba(0, 140, 220, 0.18);
          background: rgba(0, 8, 24, 0.38);
          border: 1px solid rgba(0, 184, 219, 0.10);
        ...
        .auth-hud-tl { top: 14px; left: 14px; }
        .auth-hud-tr { top: 14px; right: 14px; text-align: right; }
        .auth-hud-bl { bottom: 40px; left: 14px; }
        ...
        .auth-logo-img {
          ...
          object-fit: contain;
          filter:
            drop-shadow(0 0 6px rgba(0,150,200,0.35))
            drop-shadow(0 0 16px rgba(0,80,160,0.22))
            blur(0.2px)
            opacity(0.72);
        ...
        @keyframes apulse {
          0%,100% {
            filter:
              drop-shadow(0 0 4px rgba(0,150,200,0.28))
              drop-shadow(0 0 10px rgba(0,80,160,0.14))
              blur(0.2px)
              opacity(0.65);
          }
          50% {
            filter:
              drop-shadow(0 0 8px rgba(0,200,240,0.42))
              drop-shadow(0 0 18px rgba(0,100,200,0.22))
              blur(0.2px)
              opacity(0.82);
          }
        }
        ...
        .auth-card {
          ...
          box-shadow:
            0 0 60px rgba(0,60,150,0.38),
            0 0 120px rgba(0,30,90,0.26),
            inset 0 1px 0 rgba(0,184,219,0.10);
        ...
        .auth-corner {
          ...
          width: 14px;
          height: 14px;
          border-color: rgba(0,184,219,0.8);
          border-style: solid;
          box-shadow: 0 0 10px rgba(0,184,219,0.22);
        }
        ...
        .auth-brand-name {
          ...
          color: #f7fdff;
          text-shadow:
            0 0 20px rgba(0,184,219,0.9),
            0 0 40px rgba(0,184,219,0.32);
        }
        ...
        .auth-brand-sub {
          ...
          color: rgba(130, 225, 255, 0.82);
          margin-top: 6px;
          text-transform: uppercase;
          text-shadow: 0 0 10px rgba(0,184,219,0.22);
        }
        ...
        .auth-mode-btn:not(:last-child) {
          border-right: 1px solid rgba(0,184,219,0.12);
        }
        ...
        .auth-mode-btn.active {
          ...
          box-shadow: inset 0 0 12px rgba(0,184,219,0.10);
        }
        ...
        .auth-divider::after {
          ...
          flex: 1;
          height: 1px;
          background: linear-gradient(to right, transparent, rgba(0,184,219,0.22), transparent);
        }
        ...
        .auth-label {
          ...
          color: rgba(115, 225, 255, 0.88);
          margin-bottom: 7px;
          text-transform: uppercase;
          text-shadow: 0 0 8px rgba(0,184,219,0.22);
        }

        .auth-input {
          width: 100%;
          background: rgba(0,18,48,0.84);
          border: 1px solid rgba(0,184,219,0.18);
          border-radius: 2px;
          padding: 11px 14px;
          font-family: 'Rajdhani', sans-serif;
        ...
        .auth-input::placeholder {
          color: rgba(175, 220, 240, 0.4);
        }

        .auth-input:focus {
          border-color: rgba(0,184,219,0.5);
          background: rgba(0,25,65,0.88);
          box-shadow: 0 0 0 3px rgba(0,184,219,0.08);
        }
        ...
        .auth-msg-err {
          ...
          border-color: rgba(220,50,50,0.34);
          color: #fecaca;
        }

        .auth-msg-info {
          background: rgba(0,80,180,0.12);
          border-color: rgba(0,184,219,0.28);
          color: rgba(185,235,255,0.96);
        }

        .auth-msg-ok {
          background: rgba(0,120,80,0.12);
          border-color: rgba(0,200,130,0.25);
          color: rgba(130,235,180,0.96);
        }
        ...
        .auth-btn-primary {
          ...
          margin-top: 18px;
          padding: 13px;
          background: linear-gradient(135deg, rgba(0,184,219,0.13), rgba(0,90,200,0.18));
          border: 1px solid rgba(0,184,219,0.6);
          border-radius: 2px;
          color: #fff;
          font-family: 'Orbitron', sans-serif;
          font-size: 11px;
          ...
          justify-content: center;
          gap: 8px;
          text-shadow: 0 0 10px rgba(0,184,219,0.15);
        }

        .auth-btn-primary:hover {
          box-shadow:
            0 0 22px rgba(0,184,219,0.45),
            0 0 42px rgba(0,80,200,0.22);
          transform: translateY(-1px);
          border-color: rgba(0,220,255,0.74);
        }
        ...
        .auth-btn-ghost:hover {
          border-color: rgba(0,184,219,0.34);
        ...
        .auth-links a:hover {
          ...
          text-shadow: 0 0 8px rgba(0,184,219,0.55);
        }
        ...
        .auth-tdot {
          ...
          height: 6px;
          border-radius: 50%;
          background: rgba(0,184,219,0.9);
          box-shadow: 0 0 8px rgba(0,184,219,0.7);
          flex-shrink: 0;
          animation: atdblink 2s infinite;
        }
        ...
        .auth-ttext {
          ...
          color: rgba(145, 230, 255, 0.72);
          white-space: nowrap;
          animation: atscroll 38s linear infinite;
          text-shadow: 0 0 10px rgba(0,184,219,0.16);
        }
        ...
        .auth-spin {
          ...
          width: 10px;
          height: 10px;
          border: 1.5px solid rgba(0,184,219,0.3);
          border-top-color: rgba(0,184,219,0.95);
          border-radius: 50%;
          ...
          <div style={{ position: "relative", display: "inline-block" }}>
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(ellipse, rgba(0,120,200,0.08) 0%, rgba(0,60,140,0.04) 50%, transparent 70%)",
              }}
            />
      ...
      <div className="auth-ticker">
        ...
        <div className="auth-ttext">
          Λ L I Ξ N Λ &nbsp;INTELLIGENCE PLATFORM // SECURE CHANNEL ESTABLISHED // ALL SYSTEMS OPERATIONAL // PROJECT
          MONITORING ACTIVE // AI INFERENCE ENGINE ONLINE // PORTFOLIO ANALYTICS READY // AWAITING OPERATOR
          AUTHENTICATION //&nbsp;&nbsp;
        </div>
      </div>
    </>
