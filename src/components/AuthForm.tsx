    ...
    <>
      <style>{`
        ...
        .auth-logo-img {
          ...
          opacity: 0.96;
          filter:
            drop-shadow(0 0 10px rgba(0, 184, 219, 0.35))
            drop-shadow(0 0 22px rgba(0, 110, 220, 0.22));
        ...
        @keyframes apulse {
          0%,100% {
            filter:
              drop-shadow(0 0 8px rgba(0,184,219,0.30))
              drop-shadow(0 0 18px rgba(0,110,220,0.16));
            opacity: 0.90;
          }
          50% {
            filter:
              drop-shadow(0 0 12px rgba(0,220,255,0.42))
              drop-shadow(0 0 26px rgba(0,110,220,0.26));
            opacity: 1;
          }
        }
