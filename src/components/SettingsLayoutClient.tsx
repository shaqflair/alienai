...
const NAV: NavItem[] = [
  ...
  { href: "/settings/approvals",   label: "Approvals",   icon: "A", adminOnly: true },
  { href: "/settings/rate-card",   label: "Rate Cards",  icon: "R", adminOnly: true },
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
            <span style={{
              ...
              background:       myRole === "admin" || myRole === "owner"
                ? "rgba(124,58,237,0.1)"
                : "rgba(14,116,144,0.1)",
              color:            myRole === "admin" || myRole === "owner"
                ? "#7c3aed"
                : "#0e7490",
            }}>{myRole}</span>
            <span style={{
