...
export function createPdfChrome(opts: PdfChromeOptions) {
  ...
  function drawFooter(doc: InstanceType<typeof PDFDocument>) {
    ...
    const leftText =
      ...
      `Confidential – ${brand.clientName} – Generated by ${brand.productName} – ${today}`;
  ...
  /**
   * ✅ The ONLY safe way to create a new page:
  ...
  function addPage(doc: InstanceType<typeof PDFDocument>) {
    ...
    // 🔥 critical: reset CTM at the start of the new page
