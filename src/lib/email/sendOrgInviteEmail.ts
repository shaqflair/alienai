...
//
// Sends a branded ResForce org invite email via Resend.
...
export async function sendOrgInviteEmail(args: {
  ...
  const subject = `${inviter} invited you to join ${args.orgName} on ResForce`;
...
<body style="margin:0;padding:0;background:#f8fafc;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:560px;margin:40px auto;background:white;border-radius:16px;
    ...
    <div style="padding:32px;">
      ...
      <p style="font-size:14px;color:#475569;margin:0 0 8px;line-height:1.6;">
        ...
        <strong style="color:#0f172a;">${args.orgName}</strong> on ResForce
      ...
      <div style="margin-top:24px;padding:14px 16px;background:#f8fafc;
        ...
        <p style="font-size:11px;color:#0891b2;word-break:break-all;margin:0;">
          ${args.inviteUrl}
        </p>
      </div>
      ...
      <div style="margin-top:24px;padding-top:20px;border-top:1px solid #f1f5f9;">
        <p style="font-size:12px;color:#94a3b8;margin:0;line-height:1.6;">
          ResForce is a resource management tool for tracking team allocations,
          utilisation, and project staffing. Once you accept, you'll be able to
          view your team's heatmap, capacity, and project timeline.
        </p>
      </div>
    </div>
  ...
  const text =
    `${inviter} invited you to join ${args.orgName} on ResForce as a ${roleLabel}.\n\n` +
